	...
	<div class="container">
		<div class="row">
			<div class="col-md-9 offset-md-1">
				<h1 class="mt-5 mb-4"><i class="fa fa-pencil"></i> Modificar Usuario</h1>
				<hr>
				...
				?>
					<form action="./" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="date" class="form-control" name="birthdate" value="<?php echo $row['birthdate']; ?>" placeholder="DD/MM/AAAA" required>
						</div>
						<div class="form-group">
